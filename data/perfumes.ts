...
export const PERFUMES: Perfume[] = [
  ...
  },
  {
    ...
    tier: "luxury",
    priceText: "약 22만원대",
    notes: { top: "블랙커런트", mid: "로즈", base: "화이트 머스크" },
    mood: ["달콤한", "프루티", "플로럴", "봄", "로맨틱", "청순"],
  ...
  },
  {
    ...
    tier: "mid",
    priceText: "약 12만원대",
    notes: { top: "바다소금, 아쿠아", mid: "머스크, 릴리", base: "앰버, 화이트 우드" },
    mood: ["마린", "클린", "바다", "산뜻한", "젠더리스", "여름"],
    desc: "조개껍데기를 닮은 미네랄하고 클린한 마린 향이에요. 바다의 신선함이 피부에 스미는 듯한 자연스러운 향이에요.",
    review: "\"진짜 바다 냄새 같다\", \"뿌리면 개운하고 기분 좋다\"는 후기가 많아요.",
    target: { gender: "남녀 공용", age: "20대" },
    channels: [{ name: "탬버린즈 공식몰", url: "https://www.tamburins.com", affiliate: false }],
  },
  {
    id: "tamburins-egg",
    ...
    tier: "mid",
    priceText: "약 12만원대",
    notes: { top: "바닐라, 카모마일", mid: "파우더, 화이트 머스크", base: "샌달우드, 앰버" },
    mood: ["달콤한", "파우더리", "포근한", "귀여운", "데일리", "구르망"],
    desc: "달걀처럼 포근하고 달콤한 바닐라 파우더리 향이에요. 탬버린즈 특유의 미니멀한 패키지와 어우러져 감각적인 아이템이에요.",
    review: "\"달콤하지만 과하지 않다\", \"탬버린즈 중 제일 좋아하는 향\"이라는 후기가 많아요.",
    target: { gender: "여성", age: "20대" },
    channels: [{ name: "탬버린즈 공식몰", url: "https://www.tamburins.com", affiliate: false }],
  },
  // ── 줄리엣 헤즈 어 건 ──────────────────────────────────────
  ...
  // ── 불리 ──────────────────────────────────────────────────
  {
    id: "buly-neroli-botanica",
    brand: "Buly 1803",
    name: "Néroli Botanica",
    family: "시트러스 · 플로럴",
    tier: "luxury",
    priceText: "약 30만원대",
    notes: { top: "네롤리, 베르가못", mid: "오렌지 블로섬, 재스민", base: "머스크, 우드" },
    mood: ["산뜻한", "시트러스", "자연", "봄", "이국적인", "우아한"],
    desc: "불리 1803의 시그니처 향이에요. 프랑스 조향사가 만든 클래식하고 고급스러운 네롤리 향으로 풍성하게 표현돼요.",
    review: "\"불리 패키지만큼 향도 아름답다\", \"선물로 받으면 정말 특별하다\"는 후기가 있어요.",
    target: { gender: "남녀 공용", age: "20대 후반~50대" },
    channels: [{ name: "Buly 1803 공식몰", url: "https://www.buly1803.com/ko/", affiliate: false }],
  },
  {
    id: "buly-rose-pivoine",
    brand: "Buly 1803",
    name: "Rose Pivoine",
    family: "플로럴",
    tier: "luxury",
    priceText: "약 30만원대",
    notes: { top: "로즈, 피오니", mid: "화이트 플로럴, 아이리스", base: "머스크, 앰버" },
    mood: ["로즈", "플로럴", "우아한", "봄", "여성스러운", "럭셔리"],
    desc: "로즈와 피오니의 아름다움을 정통 프랑스 방식으로 담은 향이에요. 불리의 아름다운 패키지만큼 향도 화려해요.",
    review: "\"가장 예쁜 플로럴 향수\", \"선물용으로 이보다 좋은 게 없다\"는 후기가 있어요.",
    target: { gender: "여성", age: "20대~50대" },
    channels: [{ name: "Buly 1803 공식몰", url: "https://www.buly1803.com/ko/", affiliate: false }],
  },
  {
